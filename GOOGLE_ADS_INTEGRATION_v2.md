# Adswish v3 — Complete Build Prompt

## IMPORTANT: Implementation Rules

1. **Do NOT publish live** until I explicitly tell you to
2. **Show preview on Freebuff** at every stage so I can review
3. **Abide by Google Ads laws in ALL countries** — check compliance before each deployment
4. **Do NOT damage initial systems** — only adjust what's needed to support changes
5. **Preserve existing code** — add new features alongside, don't replace
6. **Test everything** before showing preview

---

## Overview

Full rebuild of Adswish with Google Ads integration, improved UX, plan enforcement, verification badges, and session security. Available on **ALL plans**.
...
| Feature | Free (£0) | Pro (£5/mo) | Premium (£10/mo) |
|---------|-----------|-------------|------------------|
...
| Feature | Free (£0) | Growth (£7/mo) | Enterprise (£15/mo) |
|---------|-----------|----------------|---------------------|
...
### When Signed In
```
Free ✓ Signed in as GreerCo (Business)
```
or
```
Free ✓ Signed in as SarahM (Creator)
```

- Shows plan tier: Free / Pro / Premium / Growth / Enterprise
- Shows account name
- Shows role: Business or Creator
- Visible on every dashboard page

---

## Business Onboarding (Steps 1-4)
...
- Install pixel script on website
- OR install Chrome extension
- OR verify domain for server-side tracking
- tracking_active = true

**Step 4: Plan Selection**
- Choose Free / Growth / Enterprise
- Enter payment details (if paid plan)
- plan_active = true

**Step 5: Stripe Setup (Optional for Fixed Campaigns)**
- Connect Stripe for affiliate/hybrid campaigns
- Can skip if only running fixed campaigns
- stripe_connected = true/false

### Campaign Creation Gate
- ❌ Cannot create campaigns until Steps 1-4 complete
- ✅ Can create fixed campaigns without Step 5 (Stripe)
- ❌ Cannot create affiliate/hybrid campaigns without Step 5

### Onboarding UI
```
Welcome to Adswish! Let's get you set up.

Progress: [████████░░] 4/5 complete

Step 1: Company Info        ✅ Complete
Step 2: Domain Verification ✅ Complete
Step 3: Tracking Setup      ✅ Complete
Step 4: Plan Selection      ✅ Complete
Step 5: Stripe Setup        ○ Optional (required for affiliate/hybrid)

[ Skip Stripe for Now — Run Fixed Campaigns Only ]
[ Connect Stripe — Unlock All Campaign Types ]
```
...
- **Abide by Google Ads laws in ALL countries** where the platform operates
- Check regional restrictions before each deployment
...
| Legal compliance | Check Google Ads laws in ALL countries before deployment |
...
## 28. Example Campaigns (Conditional)
...
## 29. Landing Page Final Structure

### Section Order

```
1. Hero
   "Adswish v3 is now live"
...
7. Lock & Key
   Sequential deliverable slots
   Pixel & Chrome Extension (below)
...
## 30. Pixel & Chrome Extension (Under Lock & Key)
...
## 31. Legal Documents Update

### Terms of Service
- Update version date
- Add Google Ads integration terms
- Add data sharing disclosures
- Add third-party service providers
- Update dispute resolution
- Add session timeout policy

### Privacy Policy
- Update data collection practices
- Add Google Ads data handling
- Add OAuth data usage
- Update data retention periods
- Add cookie policy for tracking pixel
- Update user rights section

### Subprocessors
- Add Google (Ads API, OAuth)
- Add Stripe (payments)
- Add Supabase (database, auth)
- Add Resend (emails)
- Add Sightengine (content moderation)
- Add Upstash (rate limiting)

---

## 32. Spelling Fixes (Complete)
...
- [ ] Plan limits enforced (Creator: Free 2, Pro 10, Premium 25)
- [ ] Plan limits enforced (Business: Free 3, Growth 10, Enterprise 25)
- [ ] Payout holds match plans (Creator: 7/5/3 days)
...
- [ ] Landing page Adswish Tools section removed
...
- [ ] Business onboarding Steps 1-4 enforced
- [ ] Campaign creation gated until onboarding complete
- [ ] Signed-in header shows plan + account name
- [ ] Legal documents updated (Terms, Privacy, Subprocessors)
- [ ] Landing page renamed to "Adswish v3 is now live"
...
1. **Do NOT publish live** until explicitly told to
2. **Show preview on Freebuff** at every stage
3. **Abide by Google Ads laws in ALL countries**
4. **Do NOT damage initial systems** — only adjust what's needed
5. **Preserve existing code** — add new features alongside
6. **Test everything** before showing preview
7. **Update legal docs** before any public launch
8. **Rename to "Adswish v3 is now live"** only after final approval
