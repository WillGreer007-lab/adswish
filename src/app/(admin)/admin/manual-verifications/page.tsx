...
export default async function AdminManualVerificationsPage() {
  ...
  const { data } = await service
    ...
    .select("id, creator_id, platform, handle, claimed_follower_count, screenshot_url, storage_path, status, review_notes, created_at, creator_profiles(display_name, profile_picture_url)")
