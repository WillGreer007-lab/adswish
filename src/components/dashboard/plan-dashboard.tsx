...
const PLANS: Record<string, PlanMeta> = {
  business_free: {
    ...
    features: ["3 active campaigns / month", "6 integrations", "Fixed-fee campaigns", "Basic pixel + extension tracking", "7-day payout holds"],
  },
  business_growth: {
    name: "Growth",
    price: "£7/mo",
    ...
    maxCampaigns: 10,
    limitLabel: "campaigns / month",
    features: ["10 active campaigns / month", "10 integrations", "Affiliate + hybrid campaigns", "Advanced tracking analytics", "2 team seats", "Priority support"],
  },
  business_enterprise: {
    name: "Enterprise",
    price: "£15/mo",
    ...
    maxCampaigns: 25,
    limitLabel: "campaigns / month",
    features: ["25 campaigns", "20 integrations", "Everything in Growth", "5 team seats", "4-hour SLA response", "Custom reporting"],
  },
  creator_free: {
    name: "Free",
    price: "£0",
    ...
    features: ["Up to 2 active campaigns", "6 integrations", "5 saved filter presets", "7-day payout hold", "Basic profile + socials"],
  },
  creator_pro: {
    name: "Pro",
    price: "£5/mo",
    ...
    maxCampaigns: 10,
    limitLabel: "active campaigns",
    features: ["Up to 10 active campaigns", "10 integrations", "Priority applicant badge", "Unlimited saved filters", "Instant payout (skip hold)"],
  },
  creator_premium: {
    name: "Premium",
    price: "£10/mo",
    ...
    maxCampaigns: 25,
    limitLabel: "active campaigns",
    features: ["25 active campaigns", "20 integrations", '"Verified Pro" badge', "Campaign performance insights", "Dedicated support"],
  },
};
